...
TRANSLATIONS = {
    'zh': {
        ...
        # Homepage Repositioning & Unified RFQ CTAs
        'POWDER METALLURGY': '粉末冶金',
        'PARTS MANUFACTURER': '零件製造商',
        'OEM Production of Gears, Rotors and Structural Components Since 1984': '自1984年以來齒輪、轉子與結構零件的 OEM 生產',
        'Submit Drawing for RFQ': '提交圖面索取報價',
        'CUSTOM POWDER': '客製化粉末',
        'METALLURGY PARTS': '冶金零件',
        'From Design Review to High-Volume Production': '從設計審查到高產量製造',
        'TAIWAN POWDER METALLURGY': '台灣粉末冶金',
        'OEM SUPPLIER': 'OEM 供應商',
        'ISO 9001 Certified Manufacturing': 'ISO 9001 認證製造',
        'RFQ Process': '詢價流程',
        'How to Get a Quote': '如何取得報價',
        'We make it simple to evaluate and quote your powder metallurgy projects. Submit your design files to start.': '我們讓評估和提供您的粉末冶金專案報價變得非常簡單。提交您的設計檔案以開始。',
        'Step 1': '步驟 1',
        'Send PDF, STEP, DWG or CAD files': '傳送 PDF、STEP、DWG 或 CAD 檔案',
        'Step 2': '步驟 2',
    ...
    'zh-cn': {
        ...
        # Homepage Repositioning & Unified RFQ CTAs
        'POWDER METALLURGY': '粉末冶金',
        'PARTS MANUFACTURER': '零件制造商',
        'OEM Production of Gears, Rotors and Structural Components Since 1984': '自1984年以来齿轮、转子与结构零件的 OEM 生产',
        'Submit Drawing for RFQ': '提交图纸索取报价',
        'CUSTOM POWDER': '定制粉末',
        'METALLURGY PARTS': '冶金零件',
        'From Design Review to High-Volume Production': '从设计审查到高产量制造',
        'TAIWAN POWDER METALLURGY': '台湾粉末冶金',
        'OEM SUPPLIER': 'OEM 供应商',
        'ISO 9001 Certified Manufacturing': 'ISO 9001 认证制造',
        'RFQ Process': '询价流程',
        'How to Get a Quote': '如何获得报价',
        'We make it simple to evaluate and quote your powder metallurgy projects. Submit your design files to start.': '我们让评估和提供您的粉末冶金项目报价变得非常简单。提交您的设计文件以开始。',
        'Step 1': '步骤 1',
        'Send PDF, STEP, DWG or CAD files': '发送 PDF、STEP、DWG 或 CAD 文件',
        'Step 2': '步骤 2',
    ...
    'de': {
        ...
        'OEM Production of Gears, Rotors and Structural Components Since 1984': 'OEM-Herstellung von Zahnrädern, Rotoren und Strukturbauteilen seit 1984',
        'Submit Drawing for RFQ': 'Zeichnung für Angebot einreichen',
        'CUSTOM POWDER': 'KUNDENSPEZIFISCHE',
        'METALLURGY PARTS': 'PULVERMETALLURGIETEILE',
        'From Design Review to High-Volume Production': 'Vom Design-Review bis zur Großserienfertigung',
        'TAIWAN POWDER METALLURGY': 'TAIWAN PULVERMETALLURGIE',
        'OEM SUPPLIER': 'OEM-LIEFERANT',
        'ISO 9001 Certified Manufacturing': 'ISO 9001 zertifizierte Fertigung',
        'RFQ Process': 'RFQ-Prozess',
        'How to Get a Quote': 'Wie Sie ein Angebot erhalten',
        'We make it simple to evaluate and quote your powder metallurgy projects. Submit your design files to start.': 'Wir machen es einfach, Ihre Pulvermetallurgie-Projekte zu bewerten und anzubieten. Reichen Sie Ihre Designdateien ein, um zu beginnen.',
        'Step 1': 'Schritt 1',
        'Send PDF, STEP, DWG or CAD files': 'Senden Sie PDF-, STEP-, DWG- oder CAD-Dateien',
        'Step 2': 'Schritt 2',
    ...
    'jp': {
        ...
        # Homepage Repositioning & Unified RFQ CTAs
        'POWDER METALLURGY': '粉末冶金',
        'PARTS MANUFACTURER': '部品メーカー',
        'OEM Production of Gears, Rotors and Structural Components Since 1984': '1984年以来、ギア、ローター、構造部品のOEM生産',
        'Submit Drawing for RFQ': '見積依頼のために図面を送る',
        'CUSTOM POWDER': 'カスタム粉末',
        'METALLURGY PARTS': '冶金部品',
        'From Design Review to High-Volume Production': '設計レビューから大量生産まで',
        'TAIWAN POWDER METALLURGY': '台湾粉末冶金',
        'OEM SUPPLIER': 'OEMサプライヤー',
        'ISO 9001 Certified Manufacturing': 'ISO 9001認証製造',
        'RFQ Process': '見積プロセス',
        'How to Get a Quote': '見積もりの取得方法',
        'We make it simple to evaluate and quote your powder metallurgy projects. Submit your design files to start.': '粉末冶金プロジェクトの評価と見積もりを簡単にします。開始するには設計ファイルを送信してください。',
        'Step 1': 'ステップ 1',
        'Send PDF, STEP, DWG or CAD files': 'PDF、STEP、DWGまたはCADファイルを送信',
        'Step 2': 'ステップ 2',
